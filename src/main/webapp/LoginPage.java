...
@WebServlet("/Loginform")       // here Loginform is the name of the servlet
public class LoginPage extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        req.getRequestDispatcher("/scratch.html").forward(req, res);            // used to include the response from another resource (servlet, JSP, HTML, etc.)
